...
public class VariableEx {
   ...
   * 식별자 만들기
   * 1. 이름 규칙
   *  1) Pascal Case : 각 단의 첫 글자는 대문자, 나머지는 소문자로 작성 (클래스)
   ...
   *     논리 : boolean
   *  2) 참조 자료형(참조 타입)
   *    (1) 값이 저장된 참조(주소)를 저장하는 REFEFENCE DATA 타입이다.
  ...
  public static void main(String[] args) {
    ...
    // long형 변수 : 8바이트 크기
    long earthAge;
    earthAge = 10000000000L;
    System.out.println(earthAge);
    
    // double형 변수 : 8바이트 크기
    double pi = 3.14156259154334342224567;
    ...
    String myName;
    myName = "공판춘"; //myName에 무엇이 있느냐? -> 공판춘의 주소값이 저장되어 있다.
